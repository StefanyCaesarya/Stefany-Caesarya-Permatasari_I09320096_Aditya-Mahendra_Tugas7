harga_sepatu = float(input('Masukkan harga sepatu awal :'))
harga_sandal = float(input('Masukkan harga sandal awal :'))
harga_flatshoes = float(input('Masukkan harga sepatu awal :'))
diskon = int(input('Masukkan diskon(tanpa persen, ct: 20) : '))
import math
sepatu1 = math.ceil(harga_sepatu * ((100-diskon)/100))
sandal1 = math.ceil(harga_sandal * ((100 - diskon) / 100))
flatshoes1 = math.ceil(harga_flatshoes * ((100 - diskon) / 100))
...
tanya3 = str(input('Untuk produk random pilihan dari kami, harga hanya 100000, apakah anda ingin?(Y/T)'))
if tanya3 == 'Y':
    import random
